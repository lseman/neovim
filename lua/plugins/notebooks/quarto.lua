...
local function with_molten_kernel(run)
        ...
        local function render(args)
            ...
            vim.fn.jobstart(cmd, {
                ...
                on_exit = function(_, code)
                    ...
                    local message = code == 0 and "Quarto render finished"
                        or ("Quarto render failed with code " .. code)
